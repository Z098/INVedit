...
namespace INVedit
{
    public class Item
    {
        ...
        public String ID
        {
            get { return (String)tag["id"]; }
            set { tag["id"].Value = value; }
        }
        public byte Count
        {
            get { return (byte)tag["Count"]; }
            set { tag["Count"].Value = value; }
        }
        public byte Slot
        {
            get { return (byte)tag["Slot"]; }
            set { tag["Slot"].Value = value; }
        }
        public short Damage
        {
            get { return (short)tag["Damage"]; }
        ...
        public Item(string id, byte count = 1, byte slot = 0, short damage = 0)
        {
